 ...
 *
 */
public class YWTWXPayDomainSimpleImpl implements IWXPayDomain {
    private YWTWXPayDomainSimpleImpl(){}
    private static class WxpayDomainHolder{
        private static IWXPayDomain holder = new YWTWXPayDomainSimpleImpl();
    }
